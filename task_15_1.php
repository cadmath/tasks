...
$qselect = 'SELECT * FROM images';
$data = $db->query($qselect);
                            ...
                            <div class="panel-content">
                                <div class="panel-content image-gallery">
                                    <div class="row">
                                        ...
                                        <a href="img/demo/gallery/<?=$img['image']?>" target="_blank"><img src="img/demo/gallery/thumb/<?=$img['image']?>"></a>
                                        <a class="btn btn-danger" onclick="confirm('Вы уверены?');" href="task_15_1_handler.php?img=<?=$img['image']?>">Удалить</a>
                                        </div>
                                        <?php } ?>
                                    </div>
                                </div>
